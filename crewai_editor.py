...
from keys import OPENAI_API_KEY, GROQ_API_KEY
...
reader = Agent(
    role="Code Reader",
    goal="Open and read provided code in this location: {location}, then point out parts that can be fixed or improved.",
    backstory="""You're a code reader that will read code and give feedback based on potential improvements you find.
